...
const emailAlertPatterns = [
    { pattern: /createdemailalert/i, type: 'WorkflowAlert' },
    { pattern: /deletedemailalert/i, type: 'WorkflowAlert' },
]

const workflowFieldUpdatePatterns = [
    { pattern: /createdfieldupdate/i, type: 'WorkflowFieldUpdate' },
    { pattern: /deletedfieldupdate/i, type: 'WorkflowFieldUpdate' },
]
...
const genericMetadataTypePatterns = [
    ...
    { pattern: /workflowrule/i, type: 'WorkflowRule'},
    { pattern: /emailalert/i, type: 'EmailAlert'},
    { pattern: /fieldupdate/i, type: 'FieldUpdate'}
];
